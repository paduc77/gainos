...
{
	{
		...
		/* .listItemType = */ CANTP_NOT_LAST_ENTRY,
		{
			...
			/* .configData.CanTpRxNSdu.CanIf_FcPduId = */ CANIF_TX_vEcuC_Pdu_1,
	...
	},
	{
		...
		/* .listItemType = */ CANTP_END_OF_LIST,
		{
			...
			/* .configData.CanTpTxNSdu.CanIf_PduId = */ CANIF_TX_vEcuC_Pdu_1,
			/* .configData.CanTpTxNSdu.PduR_PduId = */ PDUR_TX_vEcuC_Pdu_1,
