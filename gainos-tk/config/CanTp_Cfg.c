...
//NSa
const CanTp_NSaType CanTpNSaConfig_RX_vEcuC_Pdu_0 = 
{
	/* .CanTpNSa = */ 0,
};
//NTa
const CanTp_NTaType CanTpNTaConfig_RX_vEcuC_Pdu_0 = 
{
	/* .CanTpNTa = */ 0,
};
...
//NSa
const CanTp_NSaType CanTpNSaConfig_TX_vEcuC_Pdu_0 = 
{
	/* .CanTpNSa = */ 0,
};
//NTa
const CanTp_NTaType CanTpNTaConfig_TX_vEcuC_Pdu_0 = 
{
	/* .CanTpNTa = */ 0,
};
...
{
	{
		...
		/* .listItemType = */ CANTP_NOT_LAST_ENTRY,
		{
			...
			/* .configData.CanTpRxNSdu.CanIf_FcPduId = */ CANIF_TX_vEcuC_Pdu_0,
			/* .configData.CanTpRxNSdu.PduR_PduId = */ PDUR_RX_vEcuC_Pdu_0,
			...
			/* .configData.CanTpRxNSdu.CanTpRxChannel = */ CANTP_RX_vEcuC_Pdu_0,
			...
			/* .configData.CanTpRxNSdu.CanTpNSa = */ &CanTpNSaConfig_RX_vEcuC_Pdu_0,
			/* .configData.CanTpRxNSdu.CanTpNTa = */ &CanTpNTaConfig_RX_vEcuC_Pdu_0,
		}
	},
	{
		/* .direction = */ ISO15765_RECEIVE,
	...
	},
	{
		...
		/* .listItemType = */ CANTP_NOT_LAST_ENTRY,
		{
			...
			/* .configData.CanTpTxNSdu.CanIf_PduId = */ CANIF_TX_vEcuC_Pdu_0,
			/* .configData.CanTpTxNSdu.PduR_PduId = */ PDUR_TX_vEcuC_Pdu_0,
			...
			/* .configData.CanTpTxNSdu.CanTpTxChannel = */ CANTP_TX_vEcuC_Pdu_0,
			...
			/* .configData.CanTpTxNSdu.CanTpNSa = */ &CanTpNSaConfig_TX_vEcuC_Pdu_0,
			/* .configData.CanTpTxNSdu.CanTpNTa = */ &CanTpNTaConfig_TX_vEcuC_Pdu_0,
		}
	},
	{
		/* .direction = */ IS015765_TRANSMIT,
