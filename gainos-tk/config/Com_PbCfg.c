...
const uint8 vCom_IPdu1_RX_Signal0_InitValue = 0x00;
const uint8 vCom_IPdu2_TX_Signal0_InitValue = 0x00;
const uint8 vCom_IPdu2_RX_Signal0_InitValue[] ={0x00, };
...
uint8 vCom_IPdu2_TX_IPduBuffer[8];
uint8 vCom_IPdu2_RX_IPduBuffer[8];
uint8 vCom_IPdu2_RX_IPduDeferredRxBuffer[8];
...
const ComSignal_type ComSignal[] = {
	...
	},
	{
		...
		/* .ComNotification = */ vCom_IPdu1_RX_Signal0_Notification,
		/* .ComRxDataTimeoutAction = */ COM_TIMEOUT_DATA_ACTION_NONE,
		/* .ComSignalEndianess = */ COM_BIG_ENDIAN,
		/* .ComSignalInitValue = */ &vCom_IPdu1_RX_Signal0_InitValue,
		/* .ComSignalType = */ UINT8,
		/* .ComTimeoutFactor = */ 10,
		/* .ComTimeoutNotification = */ vCom_IPdu1_RX_Signal0_TimeoutNotification,
		/* .ComTransferProperty = */ TRIGGERED,
		/* .ComUpdateBitPosition = */ 0,
		/* .ComSignalArcUseUpdateBit = */ FALSE,
		/* .Com_Arc_IsSignalGroup = */ FALSE,
	...
	},
	{
		...
		/* .ComErrorNotification = */ NULL,
		/* .ComFirstTimeoutFactor = */ 10,
		/* .ComHandleId = */ vCom_IPdu2_TX_Signal0,
		/* .ComNotification = */ vCom_IPdu2_TX_Signal0_Notification,
		/* .ComRxDataTimeoutAction = */ COM_TIMEOUT_DATA_ACTION_NONE,
		/* .ComSignalEndianess = */ COM_BIG_ENDIAN,
		/* .ComSignalInitValue = */ &vCom_IPdu2_TX_Signal0_InitValue,
		/* .ComSignalType = */ UINT8,
		/* .ComTimeoutFactor = */ 10,
		/* .ComTimeoutNotification = */ vCom_IPdu2_TX_Signal0_TimeoutNotification,
		/* .ComTransferProperty = */ TRIGGERED,
		/* .ComUpdateBitPosition = */ 0,
		/* .ComSignalArcUseUpdateBit = */ FALSE,
		/* .Com_Arc_IsSignalGroup = */ FALSE,
	...
	},
	{
		...
		/* .ComErrorNotification = */ NULL,
		/* .ComFirstTimeoutFactor = */ 10,
		/* .ComHandleId = */ vCom_IPdu2_RX_Signal0,
		/* .ComNotification = */ vCom_IPdu2_RX_Signal0_Notification,
		/* .ComRxDataTimeoutAction = */ COM_TIMEOUT_DATA_ACTION_NONE,
		/* .ComSignalEndianess = */ COM_BIG_ENDIAN,
		/* .ComSignalInitValue = */ &vCom_IPdu2_RX_Signal0_InitValue,
		/* .ComSignalType = */ UINT8_N,
		/* .ComTimeoutFactor = */ 10,
		/* .ComTimeoutNotification = */ vCom_IPdu2_RX_Signal0_TimeoutNotification,
		/* .ComTransferProperty = */ TRIGGERED,
		/* .ComUpdateBitPosition = */ 0,
		/* .ComSignalArcUseUpdateBit = */ FALSE,
		/* .Com_Arc_IsSignalGroup = */ FALSE,
...
const ComSignal_type * const vCom_IPdu2_TX_SignalRefs[] = {
	&ComSignal[ vCom_IPdu2_TX_Signal0 ],
	NULL
};
const ComSignal_type * const vCom_IPdu2_RX_SignalRefs[] = {
	&ComSignal[ vCom_IPdu2_RX_Signal0 ],
	NULL
};
//I-PDU definitions
const ComIPdu_type ComIPdu[] = {
	{// vCom_IPdu1_TX
		/* .ComIPduCallout = */ vCom_IPdu1_TX_Callout,
	...
	{// vCom_IPdu1_RX
		/* .ComIPduCallout = */ vCom_IPdu1_RX_Callout,
	...
	{// vCom_IPdu2_TX
		/* .ComIPduCallout = */ vCom_IPdu2_TX_Callout,
		...
		/* .ComIPduDataPtr = */ vCom_IPdu2_TX_IPduBuffer,
		/* .ComIPduDeferredDataPtr = */ NULL,
		/* .ComIPduGroupRef = */ vCom_IPdu2_TX_SignalRefs,
		/* .ComIPduDynSignalRef = */ NULL,
		/* .Com_Arc_EOL = */ FALSE,
	},
	{// vCom_IPdu2_RX
		/* .ComIPduCallout = */ vCom_IPdu2_RX_Callout,
		...
		/* .ComIPduDataPtr = */ vCom_IPdu2_RX_IPduBuffer,
		/* .ComIPduDeferredDataPtr = */ vCom_IPdu2_RX_IPduDeferredRxBuffer,
		/* .ComIPduGroupRef = */ vCom_IPdu2_RX_SignalRefs,
		/* .ComIPduDynSignalRef = */ NULL,
		/* .Com_Arc_EOL = */ FALSE,
	},
};
...
Com_Arc_Signal_type Com_Arc_Signal[] = {
	...
	{ // vCom_IPdu2_TX_Signal0
		/* .Com_Arc_DeadlineCounter = */ 0,
		/* .ComSignalUpdated = */ 0,
	},
	{ // vCom_IPdu2_RX_Signal0
		/* .Com_Arc_DeadlineCounter = */ 0,
		/* .ComSignalUpdated = */ 0,
	},
};
