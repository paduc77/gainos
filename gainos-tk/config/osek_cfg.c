...
{
	GenTaskInfo(vTaskInit,5,256,OSDEFAULTAPPMODE|PREEMTABLE,INVALID_EVENT,1),
	GenTaskInfo(vTaskSender,6,512,OSNONEAPPMODE|PREEMTABLE,INVALID_EVENT,1),
	GenTaskInfo(vTaskReceiver,6,512,OSNONEAPPMODE|PREEMTABLE,ID_vTaskReceiverEvent,1),
	GenTaskInfo(vTaskMainFunction,4,512,OSNONEAPPMODE|PREEMTABLE,INVALID_EVENT,1),
};
