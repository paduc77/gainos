...
extern Std_ReturnType vDid_0_ReadDataLength_Cbk(uint16 *didLength);
extern Std_ReturnType vDid_0_ConditionCheckRead_Cbk(Dcm_NegativeResponseCodeType *errorCode);
extern Std_ReturnType vDid_0_ReadData_Cbk(uint8 *data);
extern Std_ReturnType vDid_0_ConditionCheckWrite_Cbk(Dcm_NegativeResponseCodeType *errorCode);
extern Std_ReturnType vDid_0_WriteData_Cbk(uint8 *data, uint16 dataLength, Dcm_NegativeResponseCodeType *errorCode);
extern Std_ReturnType vDid_0_GetScalingInfo_Cbk(uint8 *scalingInfo, Dcm_NegativeResponseCodeType *errorCode);
...
const Dcm_DspDidType DspDidList[] = { 
	{ // vDid_0,
		...
		/* DspDidSize = */ 64,
		/* /* DspDidReadDataLengthFnc = */ vDid_0_ReadDataLength_Cbk,
		/* /* DspDidConditionCheckReadFnc = */ vDid_0_ConditionCheckRead_Cbk,
		/* /* DspDidReadDataFnc = */ vDid_0_ReadData_Cbk,
		/* /* DspDidConditionCheckWriteFnc = */ vDid_0_ConditionCheckWrite_Cbk,
		/* /* DspDidWriteDataFnc = */ vDid_0_WriteData_Cbk,
		/* /* DspDidGetScalingInfoFnc = */ vDid_0_GetScalingInfo_Cbk,
...
const Dcm_DslBufferType DcmDslBufferList[DCM_DSL_BUFFER_LIST_LENGTH] = {
	...
	{ // vDcmBuffer_1_RX
		/* DslBufferID = */ 2,//? I am not that clear.
		/* DslBufferSize = */ 8,/* ?Value is not configurable */
		{ /* pduInfo */
	...
	{ // vDcmBuffer_1_TX
		/* DslBufferID = */ 3,//? I am not that clear.
		/* DslBufferSize = */ 8,/* ?Value is not configurable */
		{ /* pduInfo */
