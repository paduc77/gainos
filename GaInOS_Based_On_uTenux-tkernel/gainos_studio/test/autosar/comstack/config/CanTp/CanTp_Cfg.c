...
{
	/* .main_function_period = */ 4,
};

//NSa
const CanTp_NSaType CanTpNSaConfig_RX_vEcuC_Pdu0 = 
{
	/* .CanTpNSa = */ 0,
};
//NTa
const CanTp_NTaType CanTpNTaConfig_RX_vEcuC_Pdu0 = 
{
	/* .CanTpNTa = */ 0,
};
...
//NSa
const CanTp_NSaType CanTpNSaConfig_RX_vEcuC_Pdu4 = 
{
	/* .CanTpNSa = */ 0,
};
//NTa
const CanTp_NTaType CanTpNTaConfig_RX_vEcuC_Pdu4 = 
{
	/* .CanTpNTa = */ 0,
};
...
{
	{
		...
		/* .listItemType = */ CANTP_NOT_LAST_ENTRY,
		{
			...
			/* .configData.CanTpRxNSdu.PduR_PduId = */ PDUR_RX_vEcuC_Pdu0,
			...
			/* .configData.CanTpRxNSdu.CanTpNSa = */ &CanTpNSaConfig_RX_vEcuC_Pdu0,
			/* .configData.CanTpRxNSdu.CanTpNTa = */ &CanTpNTaConfig_RX_vEcuC_Pdu0,
		}
	},
	{
		/* .direction = */ ISO15765_RECEIVE,
	...
	},
	{
		...
		{
			/* .configData.CanTpRxNSdu.CanTp_FcPduId = */ 0xDEAD,
			/* .configData.CanTpRxNSdu.CanIf_FcPduId = */ CANIF_TX_vEcuC_Pdu4,
			/* .configData.CanTpRxNSdu.PduR_PduId = */ PDUR_RX_vEcuC_Pdu4,
			/* .configData.CanTpRxNSdu.CanTpAddressingFormant = */ CANTP_STANDARD,
			/* .configData.CanTpRxNSdu.CanTpBs = */ 4,
			/* .configData.CanTpRxNSdu.CanTpNar = */ 100,
			/* .configData.CanTpRxNSdu.CanTpNbr = */ 100,
			/* .configData.CanTpRxNSdu.CanTpNcr = */ 100,
			/* .configData.CanTpRxNSdu.CanTpRxChannel = */ CANTP_RX_vEcuC_Pdu4,
			/* .configData.CanTpRxNSdu.CanTpRxDI = */ 8,
			/* .configData.CanTpRxNSdu.CanTpRxPaddingActivation = */ CANTP_OFF,
			/* .configData.CanTpRxNSdu.CanTpRxTaType = */ CANTP_PHYSICAL,
			/* .configData.CanTpRxNSdu.CanTpWftMax = */ 5,
			/* .configData.CanTpRxNSdu.CanTpSTmin = */ 0,
			/* .configData.CanTpRxNSdu.CanTpNSa = */ &CanTpNSaConfig_RX_vEcuC_Pdu4,
			/* .configData.CanTpRxNSdu.CanTpNTa = */ &CanTpNTaConfig_RX_vEcuC_Pdu4,
		}
	},
	{
		...
		/* .listItemType = */ CANTP_NOT_LAST_ENTRY,
		{
			...
			/* .configData.CanTpTxNSdu.PduR_PduId = */ PDUR_TX_vEcuC_Pdu0,
	...
	},
	{
		...
		{
			/* .configData.CanTpTxNSdu.CanTp_FcPduId = */ 0xDEAD,
			/* .configData.CanTpTxNSdu.CanIf_PduId = */ CANIF_TX_vEcuC_Pdu4,
			/* .configData.CanTpTxNSdu.PduR_PduId = */ PDUR_TX_vEcuC_Pdu4,
			/* .configData.CanTpTxNSdu.CanTpAddressingMode = */ CANTP_STANDARD,
			/* .configData.CanTpRxNSdu.reserved_CanTpBs = */ 0xDB,
			/* .configData.CanTpTxNSdu.CanTpNas = */ 100,
			/* .configData.CanTpTxNSdu.CanTpNbs = */ 100,
			/* .configData.CanTpTxNSdu.CanTpNcs = */ 100,
			/* .configData.CanTpTxNSdu.CanTpTxChannel = */ CANTP_TX_vEcuC_Pdu4,
			/* .configData.CanTpTxNSdu.CanTpTxDI = */ 8,
			/* .configData.CanTpTxNSdu.CanTpTxPaddingActivation = */ CANTP_OFF,
			/* .configData.CanTpTxNSdu.CanTpTxTaType = */ CANTP_PHYSICAL,
			/* .configData.CanTpTxNSdu.reserved_CanTpWftMax = */ 0xDB,
			/* .configData.CanTpTxNSdu.reserved_CanTpSTmin = */ 0xDEAD,
			/* .configData.CanTpTxNSdu.CanTpNSa = */ &CanTpNSaConfig_TX_vEcuC_Pdu4,
			/* .configData.CanTpTxNSdu.CanTpNTa = */ &CanTpNTaConfig_TX_vEcuC_Pdu4,
		}
	},
};
...
const CanTp_RxIdType CanTp_RxIdList[] = 
{
	...
	/* RX_vEcuC_Pdu1 */
	{
		/* .CanTpAddressingMode =  */CANTP_STANDARD,
		/* .CanTpNSduIndex =  */1,
		/* .CanTpReferringTxIndex = */ 4,
	},
	/* RX_vEcuC_Pdu4 */
	{
		/* .CanTpAddressingMode =  */CANTP_STANDARD,
		/* .CanTpNSduIndex =  */2,
		/* .CanTpReferringTxIndex = */ 5,
	},
	/* TX_vEcuC_Pdu0 */
	{
		/* .CanTpAddressingMode =  */CANTP_STANDARD,
