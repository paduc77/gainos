...
class Ui_CanIf_Dlg(object):
    def setupUi(self, CanIf_Dlg):
        ...
        self.widget.setGeometry(QtCore.QRect(20, 20, 418, 194))
        ...
        self.leTxPduName = QtGui.QLineEdit(self.widget)
        ...
        self.cmbxTxPduCanType = QtGui.QComboBox(self.widget)
        ...
        self.spbxTxPduCanId = QtGui.QSpinBox(self.widget)
        ...
        self.cmbxTxPduCanIdType = QtGui.QComboBox(self.widget)
        ...
        self.spbxTxPduDlc = QtGui.QSpinBox(self.widget)
        ...
        self.cmbxTxPduConfirmation = QtGui.QComboBox(self.widget)
        ...
        self.widget1 = QtGui.QWidget(self.tab_5)
        self.widget1.setGeometry(QtCore.QRect(20, 20, 420, 229))
        ...
        self.label_41 = QtGui.QLabel(self.widget1)
        self.label_41.setObjectName(_fromUtf8("label_41"))
        self.horizontalLayout_8.addWidget(self.label_41)
        self.leRxPduName = QtGui.QLineEdit(self.widget1)
        ...
        self.label_38 = QtGui.QLabel(self.widget1)
        self.label_38.setObjectName(_fromUtf8("label_38"))
        self.horizontalLayout_9.addWidget(self.label_38)
        self.cmbxRxPduCanType = QtGui.QComboBox(self.widget1)
        ...
        self.spbxRxPduCanId = QtGui.QSpinBox(self.widget1)
        ...
        self.label_39 = QtGui.QLabel(self.widget1)
        self.label_39.setObjectName(_fromUtf8("label_39"))
        self.horizontalLayout_11.addWidget(self.label_39)
        self.cmbxRxPduCanIdType = QtGui.QComboBox(self.widget1)
        ...
        self.spbxRxPduDlc = QtGui.QSpinBox(self.widget1)
        ...
        self.label_42 = QtGui.QLabel(self.widget1)
        self.label_42.setObjectName(_fromUtf8("label_42"))
        self.horizontalLayout_13.addWidget(self.label_42)
        self.cmbxRxPduIndication = QtGui.QComboBox(self.widget1)
        ...
        self.leRxPduUserIndication = QtGui.QLineEdit(self.widget1)
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(290, 51, 131, 95))
