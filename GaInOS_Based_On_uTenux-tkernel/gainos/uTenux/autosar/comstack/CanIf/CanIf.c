 ...
 * Name:     parai(Wang Fan)
 * from Date:2013-04-02 22:27:00 to $Date: 2013-04-13 02:19:45 $
 * $Revision: 1.9 $
 */
...
void CanIf_InitController(uint8 Controller, uint8 ConfigurationIndex)
{
    ...
    /*const*/ Can_ControllerIdType canControllerId;
    ...
    canControllerId = ARC_GET_CHANNEL_CONTROLLER(channel);
                                       ...
                                       CanIf_ControllerModeType ControllerMode)
{
    ...
    canControllerId = ARC_GET_CHANNEL_CONTROLLER(Controller);
                                ...
                                CanIf_ChannelSetModeType PduModeRequest)
{
    // We call this a CanIf channel. Hopefully makes it easier to follow.
    CanIf_Arc_ChannelIdType channel = (CanIf_Arc_ChannelIdType) Controller;
    CanIf_ChannelGetModeType oldMode;
    ...
    oldMode = CanIf_Global.channelData[channel].PduMode;
